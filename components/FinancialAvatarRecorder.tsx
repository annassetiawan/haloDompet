...
import { FinancialAvatar, AvatarState } from './FinancialAvatar'
...
interface FinancialAvatarRecorderProps {
...
export function FinancialAvatarRecorder({
  ...
  useEffect(() => {
    ...
    if (isSpeechRecognitionSupported()) {
      ...
      console.log('✅ WebSpeech API enabled for FinancialAvatar')
    } else if (isIOSDevice()) {
      setRecorderType('ios')
      console.log('🍎 iOS fallback to IOSMediaRecorder for FinancialAvatar')
    } else {
      setRecorderType('mediarecorder')
      console.log('🌐 Fallback to MediaRecorder + Gemini STT for FinancialAvatar')
    }
  }, [])
