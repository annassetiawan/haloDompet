      ...
      {mobileMenuOpen && (
        <div className="absolute top-full left-0 right-0 p-4 md:hidden">
          <div className="bg-[#111] border border-white/10 rounded-2xl p-6 flex flex-col gap-6 shadow-2xl">
             <a href="#features" className="text-lg text-white/80" onClick={() => setMobileMenuOpen(false)}>Fitur</a>
             <a href="#demo" className="text-lg text-white/80" onClick={() => setMobileMenuOpen(false)}>Demo</a>
             <a href="#download" className="bg-violet-600 text-white text-center py-3 rounded-xl font-bold">Download App</a>
          </div>
        </div>
      )}
    </nav>
